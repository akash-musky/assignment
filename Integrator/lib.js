...
const updateIntegration= (token,id,json)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function updateIntegration","error",error,"body",response.body);
            reject(error);
        }
    })
});   
    ...
    let options={
       ...
       return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function getAllConnectionserror","error",error,"body",response.body);
            reject(error);
        }
    })
}); 
...
const createConnection= (token,json)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function createConnection","error",error,"body",response.body);
            reject(error);
        }
    })
});  
...
const createExport= (token,json)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function createExports","error",error,"body",response.body);
            reject(error);
        }
    })
});   
...
const  createImport=  (token,json)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function createdImport","error",error,"body",response.body);
            reject(error);
        }
    })
});  
...
const createFlow= (token,json)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            // console.log("function createFlow","error",error,"body",response.body);
...
const  getFlow= (token,id)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function getFlow","error",error,"body",response.body);
            reject(error);
        }
    })
});   
...
const getExport=  (token,id)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function getExport","error",error,"body",response.body);
            reject(error);
        }
    })
}); 
...
const  getAllExports= (token,id)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function getAllExports","error",error,"body",response.body);
            reject(error);
        }
    })
}); 
...
const getImport= (token,id)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function getImport","error",error,"body",response.body);
            reject(error);
        }
    })
}); 
...
const  getAllImports= (token,id)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function getAllImports","error",error,"body",response.body);
            reject(error);
        }
    })
}); 
...
const updateFlow= (token,id,json)=>{
    ...
    return new Promise((resolve,reject)=>{ 
        ...
        if(!error&&response.statusCode===200){
            ...
            console.log("function updateFlow","error",error,"body",response.body);
            reject(error);
        }
    })
}); 
